...
public class PanacheRechargeMapper {
  public static RechargeBO toDTO(PanacheRecharge entity) {
  ...
  public static PanacheRecharge toEntity(RechargeBO bo) {
    ...
    String phone = bo.getPhone().getCountryCode().toString().concat(bo.getPhone().getStateCode().toString()).concat(bo.getPhone().getNumber().toString());
