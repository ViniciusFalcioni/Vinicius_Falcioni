...
public class RechargeCelcoin implements IRechargeVendor {
    ...
    public RechargeDTO create(RechargeDTO recharge) {
        ...
        try {
            ...
            throw new RuntimeException("Erro de comunicação com o provedor do serviço de recarga.");
        }
        return recharge;
    }
    ...
    public List<OperatorDTO> listOperators(Integer stateCode, Integer category) {
        ...
        try {
            ...
            throw new RuntimeException("Erro de comunicação com o provedor do serviço de recarga.", e);
        }
    }
